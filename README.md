...
this is  base on https://github.com/docker/docker-registry

but docker-registry have some problem in apt-get update.
so I create another ubuntu update site as ftp.kaist.ac.kr .
Just add in following before RUN apt-get update . 
